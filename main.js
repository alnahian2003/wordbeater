...
function init() {
  ...
  //   Call countdown in every second
...
function countDown() {
  ...
  //   change time text color when it's below 6 to 3
  if (time <= 3) {
    timeDisplay.classList.remove("text-warning");
    timeDisplay.classList.remove("text-success");
    timeDisplay.classList.add("text-danger");
  } else if (time <= 6) {
    timeDisplay.classList.remove("text-danger");
    timeDisplay.classList.remove("text-dark");
    timeDisplay.classList.add("text-warning");
  } else if (time <= 11) {
    timeDisplay.classList.remove("text-danger");
    timeDisplay.classList.remove("text-warning");
    timeDisplay.classList.add("text-dark");
  }
}
